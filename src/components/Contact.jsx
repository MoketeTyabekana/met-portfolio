...
const Contact = () => {
  return (
    ...
    >
      ...
      <div className=" lg:flex lg:justify-between lg:items-center flex-row ">
       
          <a href="mailto:emtyabekana@gmail.com" className="lg:text-xl text-lg  bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-800/20 text-white text-center  lg:hover:shadow-[0_0_10px_rgba(59,130,246,0.7)] px-10 py-2"><h1>emtyabekana@gmail.com</h1></a>
